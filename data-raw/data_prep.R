...
early_mio_r <- read.csv("early_mio.txt", sep = ',')
mid_mio_r <- read.csv("mid_mio.txt", sep = ',')
late_mio_r <- read.csv("late_mio.txt", sep = ',')
EARLY_r <- read.csv("EARLY.txt", sep = ',')
LATE_r <- read.csv("LATE.txt", sep = ',')
MIOCENE_r <- read.csv("MIOCENE.txt", sep = ',')
...
# Saving US polygon:
#write.xlsx(x = us_imp,file =  "us.xlsx", col.names = TRUE,
#sheetName = "US polygon", append = FALSE,row.names = FALSE)
# Importing:
us <- data.frame(
  read_excel("us.xlsx", sheet = "US polygon", col_names = TRUE)
)
...
# # saving:
# for (i in 1:6){
# write.xlsx(x = f_revs[[i]], file = paste0("occ_references_",i,".xlsx"),
#                                           col.names = TRUE,
#                                           sheetName = "Matched with occurences",
#                                           append = FALSE,row.names = FALSE)
# # saving unique references:
# write.xlsx(x = unique(f_revs[[i]]), file = paste0("occ_references_",i,".xlsx"),
...
# Saving workspace:
# DO NOT RUN:
# save.image("C:/Users/Liudas/Desktop/hespdiv/study_data.RData")
#
# mio_mams <- us_l[[6]]
